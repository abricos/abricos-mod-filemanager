...
Component.entryPoint = function(NS){
    ...
    FolderPanel.prototype = {
        ...
        renderNode: function(parentNode, folder){
            ...
            this.rows.foreach(function(row){
                var di = row.cell;
                if (di['pid'] == folder['id']){
                    instance.renderNode(node, new Folder(di));
                }
            });
        },
    ...
    NS.BrowserPanel = Y.Base.create('browserPanel', SYS.Dialog, [], {
        ...
        _syncUIDialog: function(){
            ...
            this.screenshot = new Screenshot(this, tp.gel('screenshot'));
            this.folders = new FolderPanel(this, function(item){
                instance.onSelectItem_foldersPanel(item);
            });
            this.files = new FilesPanel(this, tp.gel('files'), '0', function(item){
